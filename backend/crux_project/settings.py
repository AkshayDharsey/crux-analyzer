...
SECRET_KEY = 'django-insecure-crux-analyzer-dev-key-change-in-production-12345'
...
ROOT_URLCONF = 'crux_project.urls'
...
WSGI_APPLICATION = 'crux_project.wsgi.application'
...
# CrUX API Configuration - Only this comes from .env
